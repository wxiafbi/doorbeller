...
#define  MQTT_TxData(x)       u2_TxData(x)                                         //串口3负责数据发送

#define  PRODUCTKEY           "a1HyPOJ4feR"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "Q274"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "45b7e791d569135cd5bff4a531e0e680"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  P_TOPIC_NAME         "/sys/a1HyPOJ4feR/Q274/thing/event/property/post"    //需要发布的主题  
...
char Stopic_Buff[S_TOPIC_NUM][128]=                                                //包含的是订阅的主题列表
{
	"/sys/a1HyPOJ4feR/Q274/thing/service/property/set",                            //命令下发TOPIC
};
#endif
